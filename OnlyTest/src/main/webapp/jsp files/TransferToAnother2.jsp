                ...
                <div class="ul">
                    <ul>
                        <div class="dropdown">
                            ...
                            <div class="content">
                                <a href="MainDashBoard1.jsp">Account Overview</a>
            ...
            <div class="wrapper">
                <div class="header">
                    <ul>
                        ...
                        <li class="form_2_progessbar">
                            <div class="circle2">
                                <p style="background-color: #6b59d3">2</p>
                ...
                <div class="form_wrap">
                    <div class="form_1 data_info">
                        <h2 style="padding: 0;margin: 5px 0px 5px 0px;">Confirm Details</h2>
                         <form action="OtherBank_pg2" method="post">
                            <div class="form_container">
                                <div class="form-group">
                                    <label for="account">Confirm Details</label>
                                    <input type="text" id="account" name="account" disabled value=<%=session.getAttribute("accno") %>>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="beneficiary">Beneficiary</label>
                                    <input type="text" id="beneficiary" name="beneficiary" disabled value=<%=session.getAttribute("benifname") %>>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="beneficiary account number">Beneficiary IFSC Code</label>
                                    <input type="text" id="accountNumber" name="accountNumber" disabled value=<%=session.getAttribute("benififsc") %>>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="beneficiary-bank name">Beneficiary Account Number</label>
                                    <input type="text" id="bank name" name="name" disabled value=<%=session.getAttribute("benaccno") %>>
                                </div>
                                
                                <hr>
                                <div class="form-group">
                                    <label for="transfer amount">Transfer Amount</label>
                                    <input type="text" id="amount" name="amount" disabled value=<%=session.getAttribute("trans_ammnt") %>>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="transfer description">Transfer Description</label>
                                    <input type="text" id="description" name="description" disabled value=<%=session.getAttribute("transtype") %>>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="transfer-type">Transfer Type</label>
                                    <input type="text" id="type" name="type" disabled value=<%=session.getAttribute("mobileNumber") %>>
                                </div>
                               <div class="btns_wrap">
