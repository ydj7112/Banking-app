            ...
            <div class="wrapper">
                <div class="header">
                    <ul>
                        <li class="active form_1_progessbar">
                            <h2>Congratulations!!! Beneficiary Added Successfully.</h2>
                        </li>
                    </ul>
                </div>
                ...
                <div class="form_wrap">
                    <div class="form_1 data_info">
                        <h3 style="padding: 0;margin: 5px 0px 5px 0px;">Add Beneficiary</h3>
                        
                           <div class="form_container">
                        <div class="form-group">
                            <label for="beneficiary">Beneficiary Account Number</label>
                            <input type="text" id="beneficiary" disabled value=<%=session.getAttribute("benifaccno") %>>
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                             <label for="beneficiary-bank name">Beneficiary Account Type</label>
                            <select name="acc-type" id="beneficiary-bank"  disabled>
                                <option><%=session.getAttribute("benacctype") %></option>
                                
                            </select>
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="beneficiary-bank name">IFSC</label>
                            <input type="text" id="beneficiary-bank name" disabled value=<%=session.getAttribute("benifsc") %>>
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="beneficiary account number">Beneficiary Name</label>
                            <input type="text" id="beneficiary account number" disabled value=<%=session.getAttribute("benname") %>>
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="beneficiary-bank name">Email</label>
                            <input type="text" id="beneficiary-bank name" disabled value=<%=session.getAttribute("benemail") %>>
                                
                        </div>
                               <div class="btns_wrap">
                            <div class="common_btns form_1_btns">
                                <button  class="btn_next"><a href="jsp files/MainDashBoard.jsp">Done</a> <span class="icon"></ion-icon></span></button>
                            </div>
                        </div>
                    </div>
