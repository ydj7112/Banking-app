...
<body>
    ...
    <main>
        ...
        <div class="center-container">
            <h2 class="h2">ADD Benefiacary</h2>
            <div class="wrapper">
                <div class="header">
                    <ul>
                ...
                <div class="form_wrap">
                    <div class="form_1 data_info">
                        <h2 style="padding: 0;margin: 5px 0px 5px 0px;">ADD BENEFICARY</h2>
                        
                         <form action="../AddBeneficary_pg1" method="post">
                         
                         
                    <div class="form_container">
                        <div class="form-group">
                            <label for="beneficiary">Beneficiary Account Number</label>
                            <input type="text" id="beneficiary" required name="benacc">
                        </div>
                        <hr>
                        
                        <div class="form-group">
                             <label for="beneficiary-bank name">Beneficiary Account Type</label>
                            <select name="acc-type" id="beneficiary-bank" name="acctype">
                               <option value="save" >Saving</option>
                                <option value="curr" name="acctype">Current</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="beneficiary-bank name" required name="benifsc">
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="beneficiary account number">Beneficiary Name</label>
                            <input type="text" id="beneficiary account number" required name="benname">
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="beneficiary-bank name">Email</label>
                            <input type="text" id="beneficiary-bank name" required name="benemail">
