...
<head>
    ...
    <link rel="stylesheet" href="dashboard/center-container.css">
...
<body>
            ...
            <form action="">
                <div class="icode">
                    ...
                    <div class="profile-icon">
                        <a href="jsp files/UserProfile.jsp"><img src="images/Login Icon (1).jpg"></a><span>Hi <%=session.getAttribute("name") %>...</span>
                    </div>
                    <div class="Log-Out">
    ...
    <main>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th><span>Rs.</span><%=session.getAttribute("balance") %></th>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="right-container">
            <h5>WE TAKE YOUR BANKING SECURITY </h5>
            <h5 style="color: rgb(212 107 39);">SERIOUSLY !</h5>
...
<script src="https://mediafiles.botpress.cloud/3b278125-ffe0-4d6f-9a2a-efa21454a772/webchat/config.js" defer></script>
    </main>
